    ...
    <section id="projects" className="section-container section-surface">
      ...
      <div className="max-w-5xl mx-auto space-y-4 mb-6">
        {displayedProjects.map((project) => {
          ...
          const isPrivate = !project.demo; // Determine if project is private
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1.5">
                  ...
                  {isPrivate && (
                    <span className="px-2 py-0.5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-xs font-semibold rounded-full">
                      Private Use
                    </span>
                  )}
                </div>
              ...
              <div className="flex gap-2 pt-3 border-t border-[var(--border-color)]">
                {/* Only show buttons for public projects with demos */}
                {project.demo ? (
                  <>
                    <a 
                      href={project.github}
                  ...
                  /* For private projects - show informative message instead of buttons */
                  <div className="flex-1 text-center px-4 py-3 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg">
                    <div className="flex items-center justify-center gap-2 mb-1">
                      <svg className="w-5 h-5 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                      </svg>
                      <span className="text-sm font-semibold text-themed-primary">Private Repository</span>
                    </div>
                    <p className="text-xs text-themed-muted">
                      Actively used by family • Code available upon request
                    </p>
                  </div>
                )}
              </div>
