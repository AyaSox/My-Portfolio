...
**GitHub Repository:** https://github.com/AyaSox/My-Portfolio
...
- Tailwind CSS
- React Router
- Modern ES modules & fast HMR

## Key Features
- Responsive, mobile?first layout
- Dark / Light theme toggle with persistence
- Accessible navigation (focus states, reduced?motion support)
- Smooth section scrolling and active section highlighting
- Project showcase with parsed Impact bullets
...
Frontend: React, TypeScript (selected projects), Tailwind, Material?UI (some apps)  
Databases: SQL Server, PostgreSQL, SQLite  
Tools & Infra: Docker, Hangfire, SAP HCM / SuccessFactors, GitHub, Railway / Render / Vercel  
Specialisations: HR Systems, ATS, Process Automation, Offboarding, Employment Equity

## Repository Structure
```
src/
  components/        # UI sections (Hero, About, Skills, Projects, etc.)
  data/              # Portfolio data (projects, about, experience)
  index.css          # Tailwind + theme variables
  App.jsx / main.jsx # Root composition & bootstrap
...
- Lightweight bundle (Vite tree-shaking, minimal dependencies)
